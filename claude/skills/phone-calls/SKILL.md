...
```bash
agentcash fetch https://stablephone.dev/api/call -m POST -b '{
...
```bash
agentcash fetch https://stablephone.dev/api/call/{call_id}
```
...
```bash
agentcash fetch https://stablephone.dev/api/number -m POST -b '{"area_code": "415", "country_code": "US"}'
```
...
```bash
agentcash fetch https://stablephone.dev/api/number/topup -m POST -b '{"phone_number": "+14155551234"}'
```
...
```bash
agentcash fetch https://stablephone.dev/api/numbers?wallet=YOUR_WALLET_ADDRESS
```
...
```bash
agentcash fetch https://stablephone.dev/api/number -m POST -b '{"area_code": "212", "country_code": "US"}'
```
