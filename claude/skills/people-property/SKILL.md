...
```bash
agentcash fetch https://stableenrich.dev/api/whitepages/person-search -m POST -b '{
  "firstName": "John",
  "lastName": "Smith",
  "city": "Seattle",
  "state": "WA"
...
```bash
agentcash fetch https://stableenrich.dev/api/whitepages/property-search -m POST -b '{
...
```bash
agentcash fetch https://stableenrich.dev/api/whitepages/person-search -m POST -b '{"firstName": "Jane", "lastName": "Doe", "city": "Portland", "state": "OR"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/whitepages/property-search -m POST -b '{"address": "456 Oak Avenue", "city": "Austin", "state": "TX"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/whitepages/person-search -m POST -b '{"firstName": "Michael", "lastName": "Johnson", "state": "CA"}'
```
