...
```bash
agentcash fetch https://stablestudio.dev/api/upload -m POST -b '{"filename": "image.png", "contentType": "image/png"}'
```
...
**3. Confirm upload**
```bash
agentcash fetch https://stablestudio.dev/api/upload/confirm -m POST -b '{"uploadId": "...", "blobUrl": "https://..."}'
```
