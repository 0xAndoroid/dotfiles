...
description: |
  ...
  ALWAYS use `agentcash fetch` or `agentcash fetch-auth` for stablestudio.dev endpoints.
---
...
```bash
agentcash fetch https://stablestudio.dev/api/generate/nano-banana-pro/generate -m POST -b '{
...
```bash
agentcash fetch https://stablestudio.dev/api/generate/veo-3.1/generate -m POST -b '{
...
```bash
agentcash fetch-auth https://stablestudio.dev/api/jobs/{jobId}
```
...
```bash
agentcash fetch https://stablestudio.dev/api/generate/nano-banana-pro/edit -m POST -b '{
