...
```bash
agentcash fetch https://stableenrich.dev/api/serper/news -m POST -b '{"q": "artificial intelligence regulation"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/news -m POST -b '{"q": "AI startups funding", "tbs": "qdr:w"}'
```

### Country/Language Filtering

```bash
agentcash fetch https://stableenrich.dev/api/serper/news -m POST -b '{"q": "technology news", "gl": "uk", "hl": "en"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/shopping -m POST -b '{"q": "wireless noise cancelling headphones"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/shopping -m POST -b '{"q": "MacBook Pro M3", "gl": "us"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/news -m POST -b '{"q": "company name OR competitor name", "tbs": "qdr:d", "num": 20}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/news -m POST -b '{"q": "breaking news topic", "tbs": "qdr:h"}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/shopping -m POST -b '{"q": "ergonomic office chair under $500", "num": 20}'
```
...
```bash
agentcash fetch https://stableenrich.dev/api/serper/shopping -m POST -b '{"q": "exact product name model number"}'
```
